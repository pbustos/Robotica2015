...
// LineFollower::LineFollower(InnerModel *innerModel, const RoboCompLaser::TLaserData &laserData, int delay)  //in secs
// {
...
void LineFollower::initialize(InnerModel *innerModel, const RoboCompLaser::TLaserData &laserData, int delay)
{
	this->time = QTime::currentTime();
	this->delay = delay*1000;	//msecs
 ...
 * @return void
 */
bool LineFollower::avoidanceControl(InnerModel *innerModel, const RoboCompLaser::TLaserData& laserData, float& vadvance, float& vrot)
{
 ...
 */
std::vector<float> LineFollower::computeRobotOffsets(InnerModel *innerModel, const RoboCompLaser::TLaserData &laserData)
{
...
void LineFollower::stopTheRobot(RoboCompOmniRobot::OmniRobotPrx omnirobot_proxy)
{
 ...
 * @return float
 */
float LineFollower::exponentialFunction(float value, float xValue, float yValue, float min)
{
	Q_ASSERT( yValue>0 );
