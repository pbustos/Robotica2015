...
/** \mainpage RoboComp::PickerComp
 *
 * \section intro_sec Introduction
 *
 * The PickerComp component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/PickerComp --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class PickerComp : public RoboComp::Application
{
public:
	PickerComp (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::PickerComp::run(int argc, char* argv[])
{
